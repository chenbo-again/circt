...
struct RvalueExprVisitor {
  ...
  Value visit(const slang::ast::AssertionInstanceExpression &expr) {
    mlir::emitError(loc) << "AssertionInstanceExpression not implement" << expr.localVars.size() << expr.arguments.size() << expr.isRecursiveProperty << slang::ast::toString(expr.symbol.kind);
  ...
  Value visit(const slang::ast::DisableIffAssertionExpr &assertionExpr) {
    mlir::emitError(loc) << "DisableIffAssertionExpr not implement";
  ...
  Value visit(const slang::ast::BinaryAssertionExpr &assertionExpr) {
    mlir::emitError(loc) << "BinaryAssertionExpr not implement";
    ...
    mlir::emitError(loc) << "BinaryAssertionExpr not implement " << slang::ast::toString(assertionExpr.op);
